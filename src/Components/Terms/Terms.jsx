    ...
    <div className="container mx-auto pt-24">
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-12">
          ...
          <div className="terms_cond_inner">

            <br/><br/><br/><br/>

            <h2 className="text-4xl font-bold my-2">Terms and conditions</h2>

            <p className="text-base">When you place an order with us (i.e. you make payment for an order) then you are considered
              to have read – understood and agreed to terms and conditions listed on this page.</p>

            <h5 className="text-2xl font-bold my-2">Copyright &amp; Personal Use</h5>

            <p className="text-base">The Products delivered to You are completely original content. The full copyright to the
            ...
            <h5 className="text-2xl font-bold my-2">No Plagiarism</h5>

            <p className="text-base">We do not condone, encourage, or knowingly take part in plagiarism or any other acts of fraud
            ...
            <h5 className="text-2xl font-bold my-2">Our policy for using images</h5>

            <p className="text-base">We do not own the copyright of images unless specifically designed by our in-house
              ...
              images without any worry, however, for copyright images you may require paying the owner(s).
            </p>

            <h5 className="text-2xl font-bold my-2">Refund Policy</h5>
            ...
            <h5 className="text-2xl font-bold my-2">Limitations on Revisions</h5>

            <p className="text-base">Editing Orders: We will revise edited content to ensure that no objective or technical errors
            ...
            <h5 className="text-2xl font-bold my-2">Limitation Of Liability</h5>

            <p className="text-base">You agree to release and hold the Company and its employees, officers, directors,
            ...
            <h5 className="text-2xl font-bold my-2">Amendments</h5>

            <p className="text-base">You acknowledge and agree that We may unilaterally change the Privacy policy and the Terms
            ...
            <h5 className="text-2xl font-bold my-2">Contacting Us</h5>

            <p className="text-base">If you have any query regarding our policies you may send email at:
              info@urbanbookpublishers.com</p>
            <h5 className="text-2xl font-bold my-2">Disclaimer</h5>
            <p className="text-base pb-12">All company logos and trademarks appearing on our website are the property of their
