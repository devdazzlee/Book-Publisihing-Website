...
<Service_Card     img={"https://penguinpublishers.com/assets/images/book-distrib/paperback-icon1.png"}  
heading={"Typography"}
paragraph={"We select the right typeface, font size, and layout to create a striking visual impact on the readers."}

/>
<Service_Card     img={"https://penguinpublishers.com/assets/images/book-distrib/paperback-icon2.png"}  
heading={"Illustrated"}
...
/>
<Service_Card     img={"https://penguinpublishers.com/assets/images/book-distrib/paperback-icon3.png"}  
...
<Service_Card     img={"https://penguinpublishers.com/assets/images/book-distrib/paperback-icon4.png"}  
heading={"Hand-Drawn"}
...
/>
<Service_Card     img={"https://penguinpublishers.com/assets/images/book-distrib/paperback-icon5.png"}  
heading={"Photography"}
