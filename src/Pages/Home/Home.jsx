...
function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Professional Book Writing & Publishing Services | Thereadsy
        </title>
        <meta
          name="description"
          content="Find professional book writing and publishing services at Thereadsy. Contact us for expert assistance with book writing, editing, publishing, and marketing. Whether you need a ghostwriting agency, AI tools for writing, or book promotion services, we've got you covered."
        />
      </Helmet>
      ...
      >
        ...
        {hidden ? (
          <>
            ...
            <a
              className="font-bold"
              href="tel:+17372227373"
              alt="Thereadsy Phone Number"
            >
              +1 737-222-7373
            </a>
          </>
